(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerpolicy&&(o.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?o.credentials="include":n.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();const r=document.documentElement,p=getComputedStyle(r),k=document.querySelector(".color-theme__selector");p.getPropertyValue("--color-primary");p.getPropertyValue("--color-primary-2");const w=p.getPropertyValue("--color-secondary"),T=p.getPropertyValue("--color-tertiary"),x=p.getPropertyValue("--color-grey-dark-1"),E=p.getPropertyValue("--color-grey-dark-2"),C=p.getPropertyValue("--color-grey-light-1"),$=p.getPropertyValue("--color-grey-light-2");let v=localStorage.getItem("colorTheme")||"Dark";function z(e){v=v==="Dark"?"Light":"Dark",localStorage.setItem("colorTheme",v),A()}function A(){v==="Light"?(r.style.setProperty("--color-grey-light-1",x),r.style.setProperty("--color-grey-light-2",E),r.style.setProperty("--color-grey-dark-1",C),r.style.setProperty("--color-grey-dark-2",$),r.style.setProperty("--color-tertiary",w),r.style.setProperty("--color-secondary",T),k.children[0].setAttribute("xlink:href","/sprite.svg#icon-Light")):(r.style.setProperty("--color-grey-light-1",C),r.style.setProperty("--color-grey-light-2",$),r.style.setProperty("--color-grey-dark-1",x),r.style.setProperty("--color-grey-dark-2",E),r.style.setProperty("--color-secondary",w),r.style.setProperty("--color-tertiary",T),k.children[0].setAttribute("xlink:href","/sprite.svg#icon-Dark"))}k.addEventListener("click",z);const Z=document.querySelector(".splash-screen"),ee="&lt;Ward&gt; Javascript Developer &lt;/Khaddour&gt;",te=ee.split(" ").map((e,t)=>t%2==1?e:`<tspan class="splash-screen__text--span" >${e}</tspan>`).join(" "),se=`
...
`,ke=[{companyName:"TasQment",companyLink:"https://www.tasqment.com",job:"Front-End Intern",date:"03-2021 / 11-2021",description:["Learned about Web development and started to work with HTML, CSS, Javascript, Vue.js and Quasar."]},{companyName:"TasQment",companyLink:"https://www.tasqment.com",job:"Front-End Developer",date:"12-2021 / 04-2022",description:["Worked with UI/UX designers to transform the design into responsive web app.","Worked with Back-end developers to implement APIs in the front-end app.","Engaged in daily scrum meetings with the team."]}],Le=ke.map(e=>je(e.companyName,e.companyLink,e.job,e.date,e.description)).join(""),we=`
...
`,Ie=new IntersectionObserver(e=>{e.forEach(t=>{const{id:s}=t.target;t.isIntersecting&&(R(document.querySelectorAll(`a[href='${s}']`)[0]),location.href=s)})},{threshold:.3});function R(e){document.title=`${document.title.split("|")[0]} | ${e.textContent}`||"Ward Khaddour | Front-End developer",document.querySelectorAll(".header__nav-link").forEach(t=>t.classList.remove("header__nav-link--active")),e.classList.add("header__nav-link--active")}const He=new IntersectionObserver(e=>{e.forEach(t=>{if(t.isIntersecting){const s=t.target.querySelector(".heading-linear");s&&s.classList.add("underline")}})},{threshold:.1}),F=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&(t.target.classList.add("vis"),F.unobserve(t.target))})},{threshold:1});A();setTimeout(ne,8e3);document.querySelector("body");const U=document.querySelector(".container"),u=document.querySelector(".main");U.insertAdjacentHTML("beforebegin",de);u.innerHTML+=le;u.innerHTML+=ge;u.innerHTML+=fe;u.innerHTML+=we;u.innerHTML+=Ce;u.innerHTML+=Pe;U.insertAdjacentHTML("afterend",Ae);const Oe=document.querySelector(".section-projects"),Ve=document.querySelector(".header__nav-list"),Me=document.querySelector(".form"),De=document.querySelectorAll(".skills__item-percentage"),We=document.querySelector(".projects"),S=document.querySelector(".project__popup"),Ke=document.querySelector(".project__popup-content"),Be=document.querySelector(".project__popup--image"),Re=document.querySelector(".project__popup--close"),Fe=document.querySelector(".header__toggle--button");let b,j=!1;S.addEventListener("click",j?"":B);Be.addEventListener("mousedown",e=>{e.preventDefault(),b=e.offsetX,e.offsetY,j=!0,S.addEventListener("mousemove",J)});S.addEventListener("mouseup",e=>{e.preventDefault(),j=!1,b=void 0});Ke.addEventListener("click",L);Re.addEventListener("click",B);We.addEventListener("click",Se);Me.addEventListener("submit",ce);Ve.addEventListener("click",e=>{e.target.tagName==="A"&&Je(e.target)});Fe.addEventListener("click",Ue);Oe.addEventListener("click",ye);[...u.children].forEach(e=>{Ie.observe(e),He.observe(e)});[...De].forEach(e=>{F.observe(e)});function Ue(e){document.querySelector(".header__nav").classList.toggle("header__nav--open")}function J(e){e.preventDefault(),j&&(e.offsetX<b?L(e,"right"):e.offsetX>b&&L(e,"left"),S.removeEventListener("mousemove",J))}function Je(e){R(e),document.getElementById(`#${e.href.split("#")[1]}`).scrollIntoView({behavior:"smooth"})}
